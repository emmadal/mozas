        ...
        <Card className="plan-box">
          <CardBody className="p-4">
            <div className="d-flex">
              ...
              <div className="ms-3">
                <i
                  className={"bx " + props.pricing.icon + " h1 text-warning"}
                />
              </div>
            </div>
            <div className="py-4">
              <h2>
                <sup>
                  <small>{props.pricing.price}</small>
                </sup>{" "}/{" "}
                <span className="font-size-13">{props.pricing.duration}</span>
              </h2>
            </div>
            <div className="text-center">
              <Link to={props.pricing.link} className="btn btn-primary">
            ...
            <div className="plan-features mt-5">
              {props.pricing.features.map((feature, key) => (
                <p key={"_feature_" + key}>
                  <i className="bx bx-checkbox-square text-warning me-2" />{" "}
                  {feature.title}
                </p>
              ))}
            </div>
